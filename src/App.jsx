  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {
          screen === 1 ?
            <div className="flex-1 px-[50px] py-8 flex items-center justify-center flex-col overflow-y-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4 max-w-4xl">
                ...
                >
                 ...
                 <p className='text-sm text-center'>Tell me a commedy story.</p>
                </div>
                <div
                  className="card w-[180px] cursor-pointer bg-zinc-800 transition-all hover:bg-gray-800 rounded-lg p-4"
              ...
              <div className="flex-1 px-[50px] py-4 overflow-y-auto">
                    ...
                    data ? data.map((item, index) => {
                      return (
                        <div key={index} className="mb-4">
                          {
                            item.role === "user" ?
                              <div className="user w-fit max-w-[50%] mb-4 ml-auto p-4">
                                <p className='text-xs text-gray-400 mb-1'>User</p>
                                <p className="text-sm">{item.content}</p>
                              </div> :
                              <div className="ai w-fit max-w-[50%] mb-4 mr-auto p-4">
      ...
      <div className="inputBox px-[50px] py-3 border-t border-gray-700">
        <div className="input w-full max-w-4xl mx-auto flex items-center gap-2 bg-zinc-800 rounded-lg p-1">
          <input
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                getResponse();
